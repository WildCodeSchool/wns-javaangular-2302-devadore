    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/auth/**", "/auth/checkUsername", "/auth/checkMailExist", "/api/quiz/**", "/api/users/**", "/api/question/random/quiz/**", "/api/categories", "/api/quiz/random/category/{id}", "/api/categories/notempty", "/api/quizAttempt", "/room").permitAll()
